...
import "./style.css";
import HeaderFive from "../../componentAPI/microComponent/HeaderFive";
        ...
        <div className="flex h-full">
          ...
          <div className="pl-[120px] pr-[33px] pt-[75px] border-r-[1px] border-[#1E1E1E]">
            <div className="w-[308px] flex flex-col gap-[42px]">
              <ParagraphOne>
                In this section, you will find the following detailed
                information
              </ParagraphOne>
              <div className="flex flex-col gap-[33px]">
                <a href="#" className="flex gap-3 group hover:text-[#009665]">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    className="group-hover:fill-[#009665]"
                  >
                    <path
                  ...
                  <span className="font-anek-latin text-base font-normal">
                    API Resources
                  </span>
                </a>
                ...
                <a href="#" className="flex gap-3 group hover:text-[#009665]">
                  ...
                  >
                    ...
                    <path
                      d="M12 16V19"
                      className="stroke-[#292D32] group-hover:stroke-[#009665]"
                      stroke-width="1.5"
                      stroke-miterlimit="10"
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <div className="flex flex-col">
              <div className="border-b-[1px] border-black">
                <ul className="anek-latin-font flex gap-14 pl-[52px] py-3">
                  <li>
                    <Link to="#" className="text-[#009665] text-xl font-[700]">
                      API
                    </Link>
                  </li>
                  <li>
