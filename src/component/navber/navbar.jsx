      ...
      <div className="bg-[#DEE2E2] sticky w-full top-0 z-[999]  shadow-xl md:shadow-none">
        ...
        <div className="container mx-auto py-1">
          <div className="hidden md:flex items-center justify-between gap-3">
            ...
            <a aria-label="sign-up" href="https://app.cutoutwiz.com/Identity/Account/Login?ReturnUrl=%2F" target="_blank" className="text-gray-800 text-xs lg:text-sm border-2 rounded-3xl px-4 py-1 border-[#7C9C30] font-semibold" rel="noreferrer">SIGN UP</a>
