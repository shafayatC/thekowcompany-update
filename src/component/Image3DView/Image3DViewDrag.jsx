        ...
        <>
            ...
            <div ref={viewSliderRef}
                ...
                {imageList.map((data, index) =>
                        index == 0 ?
                         <img alt="3d-image-drug" loading="lazy" draggable="false" className="sl3d absolute top-0 left-0 w-full h-full opacity-1" src={data} />
                         :
                         <img alt="3d-image-drug" loading="lazy" draggable="false" className="sl3d absolute top-0 left-0 w-full h-full opacity-0" src={data} />
