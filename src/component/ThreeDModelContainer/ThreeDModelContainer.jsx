...
const ShoeModel = lazy(() => import('../../component3d/ProductVisualization3d/Furniture/Model/ShoeModel'));
                ...
                <div className='container mx-auto'>
                    <div className='flex lg:flex-row flex-col gap-1 items-center justify-center'>
                        <div className='flex flex-col gap-5 w-full md:w-[400px]'>
                            <div>
                                <img loading="lazy" className='w-[160px] h-[70px]' src='/img/Holosnap-Logo_H_Color.webp' />
                            </div>
